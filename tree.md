...
- **`plan.md`** — Proposed migration from safe/coding modes to one always-capable assistant with project-confined file tools and persistent owner-confirmed outside access.
